...
<footer class="w-full border-t-2 border-gray-50 py-5 mt-12">
  <div class="md:px-12 lg:px-28">
    <div class="container m-auto space-y-6 text-gray-600 ">
      ...
      <div class="text-center">
        <span class="text-sm tracking-wide">Copyright © Carry Minati <span id="year"></span> | All right reserved</span>
      </div>
    </div>
  </div>
</footer>
