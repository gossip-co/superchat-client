...
const Headers = () => {
  ...
  <div
    class="mx-auto md:space-x-[50rem] border-b border-gray-800 flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8"
  >
    <Link class="block text-teal-600 grow" to={"/"}>
